## The approach to splitting the dataset into Training (validation) and testing 
## has been updated in step 3, but we will keep them here for reference and history.
## But at first we thought we had to split the dataset into three separate files
